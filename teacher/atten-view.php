...
echo 'background: linear-gradient(to right, #1F1C18, #8E0E00); ">Attendance List</i>';
echo '</div>';
echo '</div>';
...
$sql = "SELECT s.id,first_name,teacher_id,date,course_id,name,attendance FROM attendance a,course_map c,students s where a.id=s.id order by course_id";
